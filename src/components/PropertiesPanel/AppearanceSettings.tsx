        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button 
              ...
              className={`flex flex-col items-center justify-center p-3 rounded-lg border transition-all ${field.width === 'full' ? 'border-primary bg-primary/10 text-primary' : 'border-border-dark bg-background-dark text-text-secondary hover:text-white'}`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center justify-center p-3 rounded-lg border transition-all ${field.width === 'half' ? 'border-primary bg-primary/10 text-primary' : 'border-border-dark bg-background-dark text-text-secondary hover:text-white'}`}
            >
